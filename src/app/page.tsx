  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 pt-14">
          ...
          >
            <div className="flex flex-col items-center space-y-4 text-center">
              ...
              <div className="space-x-4">
                ...
                <Button
                  variant="outline"
                  className="hover:bg-primary/10 transition-all duration-300 transform hover:scale-105 hover:text-primary-foreground shadow-md hover:shadow-lg px-8 py-3"
                >
        ...
        <section
          id="features"
          className="w-full flex felx-col items-center justify-center py-24 bg-gray-100 dark:bg-gray-800"
        >
        ...
        <section
          id="how-it-works"
          className="w-full flex felx-col items-center justify-center py-24"
        >
          <div className="container px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-center mb-12">
              How It Works
              ...
              {[
                {
                  step: 1,
                  title: "Connect",
                  description: "Add MindR to your Telegram and start chatting.",
                },
                {
                  step: 2,
                  title: "Store",
