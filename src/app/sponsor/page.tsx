    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 pt-14">
        <section className="w-full flex flex-col items-center justify-center py-12 md:py-24 lg:py-32 relative overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start md:justify-between space-y-8 md:space-y-0 md:space-x-12">
              <div className="md:w-1/2 space-y-4 text-center md:text-left">
                ...
                <p className="max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                  Love using MindR? We'd love your support! Your contribution
                  helps us keep MindR running smoothly and bring you even more
                  awesome features. Every bit of support means the world to us
                  and directly helps make MindR better for everyone. Thanks for
              ...
              <div className="md:w-1/2 flex flex-col space-y-6 max-w-md">
                <Card className="transition-all duration-300 hover:shadow-lg">
                  ...
                  <CardContent className="flex flex-col items-center">
                    ...
                    <Button className="bg-[#FFDD00] text-black hover:bg-[#FFDD00]/80 shadow-lg hover:shadow-xl ">
                      <Link
                        href="https://buymeacoffee.com/muneerahmedev"
                        target="_blank"
                ...
                <Card className="transition-all duration-300 hover:shadow-lg">
                  ...
                  <CardContent className="flex flex-col items-center">
                    <p className="text-center mb-4">
                      Become a sponsor and support ongoing development
                    </p>
                    <Button className="bg-[#EA4AAA] hover:bg-[#EA4AAA]/80 shadow-lg hover:shadow-xl ">
                      <Link
                        href="https://github.com/sponsors/MuneerAhmed03"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        Sponsor on GitHub
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-to-r from-primary/20 to-secondary/20 rounded-full blur-3xl" />
        </section>
      </main>
